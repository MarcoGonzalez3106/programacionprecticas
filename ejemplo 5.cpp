...
int main(){
	...
	printf("Entero: %d Fotante: %f Carácter: %c Cadena: %s\n",i,f,c,letras);
	system("pause");
	...
	printf("%d %d %d\n",1,10,20);
	system("pause");
	printf("Probando anchos de floats: 3, 10 13 espacios\n");
	printf("%3f %10f %13f\n",f,f,f);
	system("pause");
	printf("Probando anchos de exp: 3, 13 y 16 espacios\n");
	printf("%3e %13e %16e\n",f,f,f);
	system("pause");
	f=123.456;
	...
	system("pause");
	printf("Espacificando solo las cifras decimales 1 decimal\n");
	printf("%.1f\n",f);
	system("pause");
	printf("Probando diferentes precisiones de cadenas: 10, 15 y 15.5 y .5\n");
