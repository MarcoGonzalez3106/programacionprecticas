...
recibe la direccion de la variable y los cambios que se hacen dentro
de la funcion se mantienen fuera de ella; cuando es por valor, se 
recibe una copia de la vaariable, las modificaciones que se hagan a
ese parametro dentro de la funcion no se veran reflejados fuera de ella.*/
#include <iostream>
using namespace std;
...
{
	int x;
	cout<<"dame un valor para elevar el cuadrado ";
	cin>>x;
